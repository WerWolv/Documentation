...
description: "ImHex's scripting language for analyzing and visualizing binary data."
published: true
toc:
  visible: true
---
The Pattern Language is a C++ and Rust inspired DSL that was developed for the\
[ImHex Hex Editor](/imhex) to easily define and decode binary structures found in files or memory.

## Getting Started

Before diving into the documentation, let's start with a [simple example](assets/simple-example.bin)
