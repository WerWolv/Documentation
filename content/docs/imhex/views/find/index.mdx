...
toc:
  visible: true
---
<DocumentedImage src="/assets/imhex/views/find/overview.png" alt="The Find View" caption="The Find View" />
...
<DocumentedImage src="/assets/imhex/views/find/strings.png" alt="Strings search options" caption="Strings search options" />
...
<DocumentedImage src="/assets/imhex/views/find/sequences.png" alt="Sequences search options" caption="Sequences search options" />
...
<DocumentedImage src="/assets/imhex/views/find/regex.png" alt="Regex search options" caption="Regex search options" />
...
<DocumentedImage src="/assets/imhex/views/find/binary-pattern.png" alt="Binary Pattern search options" caption="Binary Pattern search options" />

The Binary Pattern search strategy lists all byte occurrences in the data that match a given Binary Pattern. More information about the format can be found [here](/imhex/common/binary-pattern).

**Numeric Value**

<DocumentedImage src="/assets/imhex/views/find/numeric-value.png" alt="Numeric Value search options" caption="Numeric Value search options" />
